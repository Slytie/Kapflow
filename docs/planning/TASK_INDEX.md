...
| TASK-0086 | EPIC-040 | DONE | high | First controlled hotspot extraction after invariants are stable |
...
| TASK-0091 | EPIC-080 | DONE | medium | Add dependency automation, secret scanning, and explicit operator-only history follow-ups |
...
| TASK-0104 | EPIC-030 | DONE | high | Extract artifact-version and pointer-promotion mutation families |
...
| TASK-0129 | EPIC-120 | DONE | medium | Implement the backend schedule demo workpage query route and generated contract snapshot |
| TASK-0130 | EPIC-120 | DONE | medium | Implement the backend EOD demo workpage query route and generated contract snapshot |
| TASK-0131 | EPIC-120 | DONE | medium | Migrate workpage routes to the HTTP-backed repository and harden loading/freshness/shell regressions |
| TASK-0132 | EPIC-121 | DONE | medium | Freeze the artifact-backed EOD workpage contract, route family, and canonical run anchoring |
...
| TASK-0137 | EPIC-122 | DONE | medium | Freeze the workflow-run-backed workpage route family, alias posture, and draft-resolution contract |
| TASK-0138 | EPIC-122 | DONE | high | Implement the backend workflow-run-backed schedule workpage query route and generated snapshot |
...
| TASK-0143 | EPIC-123 | DONE | high | Implement backend schedule artifact projection, submit, and generated snapshots |
| TASK-0144 | EPIC-123 | DONE | high | Implement the frontend schedule artifact route, page, and landing handoff |
| TASK-0145 | EPIC-123 | DONE | medium | Close EPIC-123 and synchronize demo/doc/status posture |
| TASK-0146 | EPIC-124 | DONE | medium | Freeze the stage-linked workpage action contract, supported-surface matrix, and subject-link semantics |
...
| TASK-0152 | EPIC-125 | DONE | high | Wire the weekly Friday intake and Stage04 build/review/publish loop around Stage04-ready inputs |
...
| TASK-0154 | EPIC-125 | DONE | high | Add the minimal manual daily-replan lane through live dispatch seed activation and official delta promotion |
...
| TASK-0157 | EPIC-125 | DONE | medium | Close EPIC-125, capture first-demo feedback, and sync doc/status truth |
...
| TASK-0273 | EPIC-141 | DONE | high | Batch artifact link/provenance hydration |
...
| TASK-0285 | EPIC-143 | DONE | medium | Lifecycle Stage State workflow |
...
| TASK-0598 | EPIC-147 | DONE | high | Add fixture tier policy to CI planning |
...
| TASK-0650 | EPIC-140 | DONE | high | Draft RACI and role-permission matrix |
| TASK-0651 | EPIC-142 | DONE | high | Harden evidence status vocabulary and transition rules |
| TASK-0652 | EPIC-141 | DONE | high | Add occurrence context profile and source trust taxonomy |
| TASK-0653 | EPIC-144 | DONE | high | Define workpage-to-task generation rules |
