...
- This declaration is not CAPEX production activation, pilot approval, release/deploy approval, raw-corpus approval, or project-membership runtime approval.
...
- CAPEX project membership runtime remains blocked until project/access tasks close.
