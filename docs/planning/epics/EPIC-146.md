...
## Status
Imported as TODO backlog unless an individual task records completed repo evidence. `TASK-0589` is closed with the three-project fixture governance runbook, `TASK-0590` is closed with the K12 expected-output manifest, `TASK-0591` is closed with the K3 mini-fixture expectation catalog, and `TASK-0597` is closed with the cross-tier project-oracle manifest format; `TASK-0661` adds the first binding SME-RP fixture-case catalogue while keeping K12 as a fixture tier.
...
- `TASK-0590` (`TP-TASK-002`) - Build K12 expected-output manifest from pass11 artifacts - DONE 2026-06-17
- `TASK-0591` (`TP-TASK-003`) - Build K3 mini-fixture expectation catalog from pass11 artifacts - DONE 2026-06-17
- `TASK-0597` (`TP-TASK-009`) - Add project-oracle manifest format - DONE 2026-06-17
...
- `TASK-0590` records `docs/planning/capex_three_project_validation/K12_EXPECTED_OUTPUT_MANIFEST.yaml` as sanitized planning evidence for `TP-TASK-002`.
- `TASK-0591` records `docs/planning/capex_three_project_validation/K3_MINI_FIXTURE_EXPECTATION_CATALOG.yaml` as sanitized planning evidence for `TP-TASK-003`.
- `TASK-0597` records `docs/planning/capex_three_project_validation/PROJECT_ORACLE_MANIFEST_FORMAT.yaml` as planning evidence for `TP-TASK-009`.
...
- The runbook, manifest/catalogue, and oracle-format evidence map relevant `TP-G01..TP-G12` gates but do not pass downstream fixture release, blind baseline, scorecard, capacity, or production-preflight gates.
