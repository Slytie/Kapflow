...
## Status
Imported as TODO backlog unless an individual task records completed repo evidence. `TASK-0589` is closed with the three-project fixture governance runbook, `TASK-0590` is closed with the K12 expected-output manifest, and `TASK-0591` is closed with the K3 mini-fixture expectation catalog; `TASK-0661` adds the first binding SME-RP fixture-case catalogue while keeping K12 as a fixture tier.
...
- The runbook and manifest/catalogue evidence map relevant `TP-G01..TP-G12` gates but do not pass downstream fixture release, universal oracle format, blind baseline, scorecard, capacity, or production-preflight gates.
