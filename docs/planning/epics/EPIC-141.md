...
## Status
Imported as TODO backlog unless an individual task records completed repo evidence. `TASK-0564` is closed as of 2026-06-08 with physical source occurrence/runtime resolver evidence, `TASK-0266` is closed as of 2026-06-17 with staged corpus ingest architecture and guardrail evidence, `TASK-0267` is closed as of 2026-06-17 with deterministic content-identity/source-inventory evidence, `TASK-0268` is closed as of 2026-06-17 with source occurrence register evidence, `TASK-0269` is closed as of 2026-06-17 with role assignment and packet register artifact evidence, `TASK-0270` is closed as of 2026-06-17 with document manifest and extraction-state register artifact evidence, `TASK-0271` is closed as of 2026-06-23 with text extraction/page manifest contract evidence, `TASK-0272` is closed as of 2026-06-23 with chunk/search/evidence-binding index contract evidence, `TASK-0273` is closed as of 2026-06-23 with batch artifact link/provenance hydration evidence, `TASK-0274` is closed as of 2026-06-23 with planning-only async document-processing job runtime evidence, `TASK-0372` and `TASK-0373` are closed as of 2026-06-23 with bounded artifact list pagination and batch relation hydration RF evidence, `TASK-0374` is closed as of 2026-06-23 with the planning-only bulk ingest adapter seam over sanitized staged descriptors, `TASK-0391` is reconciled as of 2026-06-23 to existing `TASK-0564` content identity/source occurrence schema evidence, `TASK-0392` is closed as of 2026-06-23 with internal same-project source occurrence relation state, `TASK-0393` is closed as of 2026-06-23 with internal ingest batch/job/attempt/log state, `TASK-0394` is closed as of 2026-06-23 with metadata-only archive lineage outputs over existing source occurrence relation rows, `TASK-0395` is closed as of 2026-06-23 with manifest-generation attestation outputs from physical corpus rows only, `TASK-0396` is closed as of 2026-06-23 with canonical command receipt input hash/profile evidence, `TASK-0397` is closed as of 2026-06-23 with durable EffectLedger and guarded mutation helper evidence, `TASK-0398` is closed as of 2026-06-23 with internal ToolExecutionAttempt lease-token stale-completion rejection evidence, `TASK-0399` is closed as of 2026-06-23 with internal project concurrency policy/runtime slot evidence for ingest and pointer locks, `TASK-0400` is closed as of 2026-06-23 with RuntimeOutbox relay scaffold evidence over canonical timeline events and consumer cursors, `TASK-0401` is closed as of 2026-06-23 with ArtifactVersion identity profile/digest metadata evidence, `TASK-0403` is closed as of 2026-06-23 with append-only ArtifactPointerEvent and PointerFamilyPolicy schema/helper evidence, `TASK-0405` is closed as of 2026-06-23 with submitted/runtime generated artifact schema-boundary evidence, and `TASK-0652` is closed with the SME-RP source occurrence context and trust contract. Parser/OCR runtime, queue workers, locator unions, archive extraction runtime, external relay/bus wiring, broad worker migration, broad command-enforcement wiring, pointer-promotion service work, validation-run vector work, runtime-computed provenance hardening, and extraction/evidence-binding runtime work remain open.
...
- `TASK-0372` (`RF-004`) - Artifact list pagination adapter - DONE 2026-06-23
- `TASK-0373` (`RF-005`) - Batch relation hydration - DONE 2026-06-23
- `TASK-0374` (`RF-006`) - Bulk ingest adapter seam - DONE 2026-06-23
- `TASK-0391` (`ARCH-W2-S01`) - Create content_identity and capex_source_occurrence runtime schema - DONE 2026-06-23
- `TASK-0392` (`ARCH-W2-S02`) - Add source_occurrence_relation with duplicate/archive/derivative/redaction relation types - DONE 2026-06-23
- `TASK-0393` (`ARCH-W2-S03`) - Add ingest_batch, ingest_job, ingest_attempt, ingest_job_log state model - DONE 2026-06-23
- `TASK-0394` (`ARCH-W2-S04`) - Add archive lineage support and nested-archive extraction metadata contract - DONE 2026-06-23
- `TASK-0395` (`ARCH-W2-S05`) - Add manifest_generation attestation model for generated corpus registers - DONE 2026-06-23
- `TASK-0396` (`ARCH-W2-S06`) - Implement CommandReceipt canonical input hash and corrupted-idempotency rejection - DONE 2026-06-23
- `TASK-0397` (`ARCH-W2-S07`) - Implement EffectLedger and guarded mutation helper - DONE 2026-06-23
- `TASK-0398` (`ARCH-W2-S08`) - Split ToolExecution from ToolExecutionAttempt with lease-token stale completion rejection - DONE 2026-06-23
- `TASK-0399` (`ARCH-W2-S09`) - Add ProjectConcurrencyPolicy and ProjectRuntimeSlot minimal implementation - DONE 2026-06-23
- `TASK-0400` (`ARCH-W2-S10`) - Add RuntimeOutbox after-commit dispatch scaffold - DONE 2026-06-23
- `TASK-0401` (`ARCH-W2-S11`) - Define ArtifactVersionIdentityContract and add identity fields - DONE 2026-06-23
- `TASK-0402` (`ARCH-W2-S12`) - Harden ArtifactProvenanceEdge as runtime-computed immutable typed edge
- `TASK-0403` (`ARCH-W2-S13`) - Define ArtifactPointerEvent and PointerFamilyPolicy minimal schema - DONE 2026-06-23
- `TASK-0404` (`ARCH-W2-S14`) - Implement PointerPromotionService guarded transaction
- `TASK-0405` (`ARCH-W2-S15`) - Define SubmittedGeneratedArtifact and RuntimeGeneratedArtifactView schemas - DONE 2026-06-23
