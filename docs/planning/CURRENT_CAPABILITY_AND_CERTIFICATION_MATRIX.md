...
- Workpage routes are certified for the current query-backed demo surfaces only; this pass does not certify the future artifact-backed EOD draft/projection/submit path yet.
