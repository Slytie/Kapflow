...
### Reserved artifact-backed schedule posture (future implementation)
...
## Snapshot policy
Once implementation starts, backend-generated snapshots should cover:
- a representative schedule artifact-backed read response,
- a representative submit/create-new-version response,
- and any route payloads needed by frontend migration.
