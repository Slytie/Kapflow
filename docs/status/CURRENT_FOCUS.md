...
1. TASK-0083 - Land route-boundary fitness and the shared read-model seam once scoped receipts are in place.
2. TASK-0084 and TASK-0085 - Tighten bundle truth and bootstrap/governance honesty in parallel where safe.
3. TASK-0086 - Attempt the first controlled hotspot extraction only after the invariant tasks are complete and green.
