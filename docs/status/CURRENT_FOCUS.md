...
- The next EPIC-136 delivery-governance pair is now closed: `TASK-0582` adds the CAPEX Product Goal and guarded metric stack, and `TASK-0583` adds the first vertical-slice ladder (`VS-00` through `VS-05`). This is planning evidence only; `TASK-0584` remains open for dependency/risk milestone work and CAPEX activation remains blocked.
