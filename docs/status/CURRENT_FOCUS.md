...
- The EPIC-144/151 Risk/Stale cockpit and procurement-threshold pair is now closed: `TASK-0299` records the planning-only Risk / Stale / CEO Cockpit workpage projection contract/helper with risk cards, stale/blocker cards, CEO management-action cards, SourceRef drilldowns, forecastability/caveat display, and no generated workpage authority; `TASK-0659` records the planning-only Annex B procurement field and executive threshold-family contract/helper with no numeric threshold values and commercial evidence limited to observed/reconciled posture. `TASK-0539` RiskSignal and `TASK-0540` W8 CEO transparency schema/freshness remain open. CEO cockpit UI, public routes, frontend routes, runtime risk engine, authored workflow activation, numeric threshold signoff, procurement workflow activation, ERP/accounting behavior, official pointers, closure snapshots, external-system activation, and CAPEX runtime/product behavior remain blocked.
