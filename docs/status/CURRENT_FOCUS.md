...
1. TASK-0079 - Introduce shared capability-decision primitives for read-side actionability.
2. TASK-0081 - Split public artifact upload from local seeding via ingress descriptors.
3. TASK-0080 - Enforce the frozen capability decisions at the write boundary.
4. TASK-0082 and TASK-0083 - Land scoped idempotency receipts and route-boundary fitness once the earlier seams are stable.
5. TASK-0084 and TASK-0085 - Tighten bundle truth and bootstrap/governance honesty in parallel where safe.
6. TASK-0086 - Attempt the first controlled hotspot extraction only after the invariant tasks are complete and green.
