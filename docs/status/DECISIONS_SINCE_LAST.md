...
- Preflight-routing decision: the master production-preflight review now has supporting review refs for `TASK-0600..TASK-0603`; remaining unresolved checks are routed to `TASK-0604..TASK-0606`.
- Fixture boundary decision: raw/full corpora remain off-repo and later fixture release, blind baseline execution, release/activation evidence, review-tier/CI enforcement, final go/no-go approval, and activation gates remain open.
