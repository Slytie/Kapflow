# Dispatch Reporting - EOS actuals normalization and packet finalization

This folder contains the target authored workflow surface for `dispatch_reporting.v1`.
