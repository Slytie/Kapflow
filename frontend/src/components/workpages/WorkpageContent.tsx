...
export function WorkpageSummaryCardsSection({
  ...
  return (
    <section
      className={`workpage-summary-section${className ? ` ${className}` : ""}`}
      aria-labelledby={titleId}
      data-testid="workpage-summary-section"
    >
      ...
      <div className="workpage-summary-cards">
        {section.cards.map((card) => (
          <article
            key={card.key}
            className="workpage-summary-card"
            data-testid={`workpage-summary-card-${card.key}`}
          >
            <span className="workpage-summary-card__label">{card.label}</span>
            <strong className="workpage-summary-card__value">{card.value}</strong>
          </article>
        ))}
      </div>
    </section>
