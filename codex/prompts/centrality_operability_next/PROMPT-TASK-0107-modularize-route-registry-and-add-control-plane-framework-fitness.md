...
- codex/tasks/TASK-0107-modularize-route-registry-and-add-control-plane-framework-fitness.md
- src/onetruth/api/route_registry.py
- src/onetruth/api/main.py
- tests/unit/test_api_route_registry.py

### Ask-mode objective
Split the registry by resource while keeping one declarative truth surface and adding framework-sprawl guardrails.
...
```text
You are resuming `TASK-0107` in **Code mode**.
...
- targeted runtime API smoke tests
