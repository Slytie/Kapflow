...
- codex/tasks/TASK-0104-extract-artifact-version-and-pointer-promotion-families.md
...
### Ask-mode objective
Extract artifact/pointer mutation families and move lineage/canonical-scope helpers behind a neutral seam.
...
```text
You are resuming `TASK-0104` in **Code mode**.
...
### Verification to run
- targeted pytest for artifact/pointer paths
