...
- codex/tasks/TASK-0103-extract-flag-and-stage07-issue-loop-family.md
...
### Ask-mode objective
Extract the flag / Stage07 issue-loop mutation family without changing semantics.
...
```text
You are resuming `TASK-0103` in **Code mode**.
...
### Verification to run
- targeted pytest for flag / Stage07 flows
