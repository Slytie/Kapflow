...
- codex/tasks/TASK-0105-extract-execution-tool-and-policy-command-family.md
...
### Ask-mode objective
Extract execution/tool/policy commands so Stage06/Stage04 services stop depending on the legacy hotspot.
...
```text
You are resuming `TASK-0105` in **Code mode**.
...
### Verification to run
- targeted pytest for execution/tool/policy paths
