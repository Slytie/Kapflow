...
- codex/tasks/TASK-0109-split-repo-assurance-domains-and-portable-validator-entrypoints.md
...
### Ask-mode objective
Split the assurance layer into clearer domains and make validator entrypoints more portable and truthful.
...
```text
You are resuming `TASK-0109` in **Code mode**.
