...
id: TASK-0343
epic: EPIC-149
title: "P4A stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P4A-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Source triage, K3 shadow regression, reserved contracts implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P4A-B`
- Source phase: `P4A`
- Source priority: `P1`
- Source area: `refactoring`
- Original depends_on: `P4A implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P4A implementation slices
- Recommended source branch: `feature/capex-p4a-stabilize`
