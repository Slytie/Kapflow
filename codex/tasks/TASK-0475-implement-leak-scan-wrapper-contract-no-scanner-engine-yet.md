...
id: TASK-0475
epic: EPIC-145
title: "Implement leak-scan wrapper contract, no scanner engine yet"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-007` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
wrapper interface + fail-closed tests
...
Implementation artifact(s) implied by W6-SLICE-007; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-007; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-007`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P0`
- Source area: `fixture/ai/security`
- Original depends_on: `schemas defined`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: schemas defined
