...
id: TASK-0627
epic: EPIC-150
title: Add local deletion does not delete evidence tests
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0612]
risk: critical
...
Mapped CAPEX / research source rows: `DFS-TEST-003`.

## Objective

Test missing local file creates stale/missing-source task while governed evidence remains.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0627-add-local-deletion-does-not-delete-evidence-tests.md`
