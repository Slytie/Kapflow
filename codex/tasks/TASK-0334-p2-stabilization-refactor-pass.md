...
id: TASK-0334
epic: EPIC-149
title: "P2 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P2-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Domain boundary and logistics side-effect extraction implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P2-B`
- Source phase: `P2`
- Source priority: `P0`
- Source area: `refactoring`
- Original depends_on: `P2 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P2 implementation slices
- Recommended source branch: `feature/capex-p2-stabilize`
