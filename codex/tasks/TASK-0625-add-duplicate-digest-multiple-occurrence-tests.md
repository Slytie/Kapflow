...
id: TASK-0625
epic: EPIC-150
title: Add duplicate digest / multiple occurrence tests
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0614]
risk: critical
...
Mapped CAPEX / research source rows: `DFS-TEST-001`.

## Objective

Test identical bytes in two folder contexts produces separate source occurrences.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0625-add-duplicate-digest-multiple-occurrence-tests.md`
