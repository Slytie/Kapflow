...
Mapped CAPEX / research source rows: `DST-004; DFS-D05; DFS-DELTA-004`.

## Objective

Define how a resync compares snapshots and emits reviewable deltas without mutating reviewed baselines.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0610-specify-manual-resync-and-snapshot-delta-reconciliation.md`
