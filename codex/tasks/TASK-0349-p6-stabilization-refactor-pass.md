...
id: TASK-0349
epic: EPIC-149
title: "P6 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P6-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Generated artifact framework and validation implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P6-B`
- Source phase: `P6`
- Source priority: `P0`
- Source area: `refactoring`
- Original depends_on: `P6 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P6 implementation slices
- Recommended source branch: `feature/capex-p6-stabilize`
