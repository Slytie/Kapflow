...
id: TASK-0637
epic: EPIC-150
title: Add CODEOWNERS / specialist review gates for desktop source-root code
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [EPIC-147, EPIC-148]
risk: high
...
Mapped CAPEX / research source rows: `SD-TASK-*; DFS-CORE-04`.

## Objective

Require security/privacy, backend, PM workflow, and CAPEX formalism review for EPIC-150 changes.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0637-add-codeowners-specialist-review-gates-for-desktop-source-root-code.md`
