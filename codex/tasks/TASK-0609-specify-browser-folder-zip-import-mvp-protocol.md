...
# TASK-0609 — Specify browser folder / ZIP import MVP protocol
...
Mapped CAPEX / research source rows: `DST-003; DFS-DELTA-002`.

## Objective

Define manifest-first, project-scoped import with authorization before blob upload and no background-sync assumptions.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0609-specify-browser-folder-zip-import-mvp-protocol.md`
