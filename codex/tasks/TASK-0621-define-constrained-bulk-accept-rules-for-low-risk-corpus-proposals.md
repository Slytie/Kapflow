...
id: TASK-0621
epic: EPIC-150
title: Define constrained bulk-accept rules for low-risk corpus proposals
status: TODO
owners: [capex-platform]
reviewers: [backend, capex-architecture]
depends_on: [TASK-0619, TASK-0620]
risk: medium
context_packs: [codex/context/EPIC-150.md]
patterns: [ProposedCorpusStructure, CorpusStructureReviewDecision]
---

# TASK-0621 — Define constrained bulk-accept rules for low-risk corpus proposals
...
Mapped CAPEX / research source rows: `DFS-CORE-03`.

## Objective

Allow bulk acceptance only for low-risk rows with complete SourceRefs, confidence, non-sensitive triage, and undo/review trace.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0621-define-constrained-bulk-accept-rules-for-low-risk-corpus-proposals.md`
