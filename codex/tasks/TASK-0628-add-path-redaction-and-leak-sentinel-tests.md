...
id: TASK-0628
epic: EPIC-150
title: Add path redaction and leak-sentinel tests
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0613]
risk: critical
...
Mapped CAPEX / research source rows: `DFS-TEST-005; DFS-CORE-04`.

## Objective

Test local absolute paths, usernames, machine names, and sensitive labels are redacted from logs/prompts/exports.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0628-add-path-redaction-and-leak-sentinel-tests.md`
- `tests/**/capex_desktop_folder_sync_*`
