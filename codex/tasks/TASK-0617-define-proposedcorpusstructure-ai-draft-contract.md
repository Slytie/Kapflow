...
id: TASK-0617
epic: EPIC-150
title: Define ProposedCorpusStructure AI draft contract
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [EPIC-141, EPIC-142, TASK-0610]
risk: high
...
Mapped CAPEX / research source rows: `DST-005; DFS-CORE-03`.

## Objective

Define AI draft roles, packets, triage, confidence, warnings, and source refs.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0617-define-proposedcorpusstructure-ai-draft-contract.md`
