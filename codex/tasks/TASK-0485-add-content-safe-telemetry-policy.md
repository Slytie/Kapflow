...
id: TASK-0485
epic: EPIC-145
title: "Add content-safe telemetry policy"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-017` so future work can be executed from repo-native backlog memory without loading the full master package.
...
Implementation artifact(s) implied by W6-SLICE-017; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-017; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-017`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P0`
- Source area: `fixture/ai/security`
- Original depends_on: `logging conventions`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: logging conventions
