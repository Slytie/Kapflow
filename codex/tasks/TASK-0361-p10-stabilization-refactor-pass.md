...
id: TASK-0361
epic: EPIC-149
title: "P10 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P10-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Scale, storage and deployment capacity gates implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P10-B`
- Source phase: `P10`
- Source priority: `P1`
- Source area: `refactoring`
- Original depends_on: `P10 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P10 implementation slices
- Recommended source branch: `feature/capex-p10-stabilize`
