...
id: TASK-0489
epic: EPIC-145
title: "Update workpage family catalog for fixture release and AI draft review"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-021` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
workpage rows + command model
...
Implementation artifact(s) implied by W6-SLICE-021; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-021; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-021`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P1`
- Source area: `fixture/ai/security`
- Original depends_on: `W5 projection model`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: W5 projection model
