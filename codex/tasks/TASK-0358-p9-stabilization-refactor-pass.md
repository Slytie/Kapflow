...
id: TASK-0358
epic: EPIC-149
title: "P9 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P9-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Risk, CEO transparency, stale/reopen, officialness implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P9-B`
- Source phase: `P9`
- Source priority: `P0`
- Source area: `refactoring`
- Original depends_on: `P9 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P9 implementation slices
- Recommended source branch: `feature/capex-p9-stabilize`
