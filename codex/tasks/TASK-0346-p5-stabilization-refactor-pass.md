...
id: TASK-0346
epic: EPIC-149
title: "P5 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P5-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Bulk corpus ingest and document indexing implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P5-B`
- Source phase: `P5`
- Source priority: `P0`
- Source area: `refactoring`
- Original depends_on: `P5 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P5 implementation slices
- Recommended source branch: `feature/capex-p5-stabilize`
