...
id: TASK-0632
epic: EPIC-150
title: Add leak-scan surfaces for exports, screenshots, generated packs, and CI artifacts
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0613, EPIC-146, EPIC-147]
risk: critical
...
Mapped CAPEX / research source rows: `DFS-CORE-04`.

## Objective

Extend leak-scan policy to desktop-sync artifacts and fixtures.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0632-add-leak-scan-surfaces-for-exports-screenshots-generated-packs-and-ci-artifacts.md`
