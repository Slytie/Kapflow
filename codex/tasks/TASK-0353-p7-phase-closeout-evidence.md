...
id: TASK-0353
epic: EPIC-149
title: "P7 phase closeout evidence"
status: TODO
owners: ["qa"]
...
## Why
Imported from CAPEX v6 source task `QD-P7-C` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Collect acceptance, review, docs, metrics, and risk evidence for Core CAPEX workflows.
...
## Source row mapping
- Source task ID: `QD-P7-C`
- Source phase: `P7`
- Source priority: `P0`
- Source area: `quality gates`
- Original depends_on: `P7 gates`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P7 gates
