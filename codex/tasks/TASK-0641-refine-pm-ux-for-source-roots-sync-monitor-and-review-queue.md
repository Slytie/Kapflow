...
id: TASK-0641
epic: EPIC-150
title: Refine PM UX for Source Roots, Sync Monitor, and Review Queue
status: TODO
owners: [capex-platform]
reviewers: [backend, capex-architecture]
depends_on: [TASK-0619]
risk: medium
...
Define user-facing states and explanations so PMs understand observation/proposal/review/official boundaries.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0641-refine-pm-ux-for-source-roots-sync-monitor-and-review-queue.md`
- `frontend/src/**/capex workpage surfaces`
- `tests/**/workpage command/projection tests`
