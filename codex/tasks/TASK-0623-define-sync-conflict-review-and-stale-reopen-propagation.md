...
id: TASK-0623
epic: EPIC-150
title: Define sync conflict review and stale/reopen propagation
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0610, TASK-0612, EPIC-145]
risk: critical
...
Mapped CAPEX / research source rows: `DST-008; DFS-CORE-02`.

## Objective

Map deltas to stale/reopen review tasks for packets, evidence, commitment, assumption, closure, snapshots.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0623-define-sync-conflict-review-and-stale-reopen-propagation.md`
