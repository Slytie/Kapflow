...
id: TASK-0636
epic: EPIC-150
title: Add K12/K3/blind validation coverage for desktop source-root behavior
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [EPIC-147, TASK-0625, TASK-0626, TASK-0627]
risk: high
...
Mapped CAPEX / research source rows: `TP-*; DFS-CORE-09 implied`.

## Objective

Ensure desktop-folder workflow is tested against K12, K3, and blind holdout without raw data in repo/CI.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0636-add-k12-k3-blind-validation-coverage-for-desktop-source-root-behavior.md`
