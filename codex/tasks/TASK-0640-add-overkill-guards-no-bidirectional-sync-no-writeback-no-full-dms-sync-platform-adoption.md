...
id: TASK-0640
epic: EPIC-150
title: "Add overkill guards: no bidirectional sync, no writeback, no full DMS/sync-platform adoption"
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0607]
risk: high
...
Mapped CAPEX / research source rows: `DFS-RISK-*`.

## Objective

Prevent scope drift into a full synchronization/DMS product.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0640-add-overkill-guards-no-bidirectional-sync-no-writeback-no-full-dms-sync-platform-adoption.md`
