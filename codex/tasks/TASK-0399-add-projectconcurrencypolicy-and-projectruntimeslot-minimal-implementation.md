...
## Why
Imported from CAPEX v6 source task `ARCH-W2-S09` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Start with ingest and pointer locks only
...
Implementation artifact(s) implied by W2-S09; source wave W2; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W2-S09; source wave W2; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W2-S09`
- Source phase: `P4/P5 Corpus and effects`
- Source priority: `P0`
- Source area: `corpus/effects/artifacts/validation`
- Original depends_on: `W1 project root`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: W1 project root
