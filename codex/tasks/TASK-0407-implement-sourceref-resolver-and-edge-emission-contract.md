...
id: TASK-0407
epic: EPIC-141
title: "Implement sourceRef resolver and edge-emission contract"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `ARCH-W2-S17` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
ACL/project scope must be checked
...
Implementation artifact(s) implied by W2-S17; source wave W2; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W2-S17; source wave W2; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W2-S17`
- Source phase: `P4/P5 Corpus and effects`
- Source priority: `P0`
- Source area: `corpus/effects/artifacts/validation`
- Original depends_on: `W2-S01/W2-S12/W2-S16`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: W2-S01/W2-S12/W2-S16
