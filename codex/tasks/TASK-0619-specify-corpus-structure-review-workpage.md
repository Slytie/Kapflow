...
id: TASK-0619
epic: EPIC-150
title: Specify Corpus Structure Review Workpage
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [EPIC-144, TASK-0617]
risk: high
...
Mapped CAPEX / research source rows: `DST-006; DFS-CORE-03`.

## Objective

Design PM workpage for reviewing AI proposed corpus structure, triage, packets, corrections, and delegations.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0619-specify-corpus-structure-review-workpage.md`
