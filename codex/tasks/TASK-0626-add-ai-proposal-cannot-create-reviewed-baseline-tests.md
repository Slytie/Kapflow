...
id: TASK-0626
epic: EPIC-150
title: Add AI proposal cannot create reviewed baseline tests
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0617, TASK-0620]
risk: critical
...
Mapped CAPEX / research source rows: `DFS-TEST-002`.

## Objective

Test AI proposal exists but reviewed baseline remains absent until PM review decision.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0626-add-ai-proposal-cannot-create-reviewed-baseline-tests.md`
