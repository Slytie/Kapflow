...
id: TASK-0638
epic: EPIC-150
title: Curate and annotate desktop-sync snippet usage for Codex
status: TODO
...
Mapped CAPEX / research source rows: `DFS snippets`.

## Objective

Map included snippets to tasks and add warnings that snippets are illustrative only.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0638-curate-and-annotate-desktop-sync-snippet-usage-for-codex.md`
