...
id: TASK-0474
epic: EPIC-145
title: "Define leak_scan_report and fixture_release_manifest schemas"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-006` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
schemas + fail-closed tests
...
Implementation artifact(s) implied by W6-SLICE-006; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-006; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-006`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P0`
- Source area: `fixture/ai/security`
- Original depends_on: `scanner wrapper skeleton`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: scanner wrapper skeleton
