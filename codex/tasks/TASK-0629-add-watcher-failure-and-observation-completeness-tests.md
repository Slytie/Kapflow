...
id: TASK-0629
epic: EPIC-150
title: Add watcher failure and observation completeness tests
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0611]
risk: high
...
Test watcher overflow/lost event/inaccessible subtree forces full scan or blocks freshness.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0629-add-watcher-failure-and-observation-completeness-tests.md`
