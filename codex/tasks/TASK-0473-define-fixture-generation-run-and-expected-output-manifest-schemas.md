...
id: TASK-0473
epic: EPIC-145
title: "Define fixture_generation_run and expected_output_manifest schemas"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-005` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
schemas + deterministic generation tests
...
Implementation artifact(s) implied by W6-SLICE-005; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-005; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-005`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P0`
- Source area: `fixture/ai/security`
- Original depends_on: `module catalog`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: module catalog
