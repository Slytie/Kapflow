...
id: TASK-0355
epic: EPIC-149
title: "P8 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P8-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Workpages and governed command surfaces implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P8-B`
- Source phase: `P8`
- Source priority: `P0`
- Source area: `refactoring`
- Original depends_on: `P8 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P8 implementation slices
- Recommended source branch: `feature/capex-p8-stabilize`
