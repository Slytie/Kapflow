...
id: TASK-0337
epic: EPIC-149
title: "P3 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P3-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after CAPEX project and access foundation implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P3-B`
- Source phase: `P3`
- Source priority: `P0`
- Source area: `refactoring`
- Original depends_on: `P3 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P3 implementation slices
- Recommended source branch: `feature/capex-p3-stabilize`
