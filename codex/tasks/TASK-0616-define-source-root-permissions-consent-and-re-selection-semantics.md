...
id: TASK-0616
epic: EPIC-150
title: Define source-root permissions, consent, and re-selection semantics
status: TODO
...
# TASK-0616 — Define source-root permissions, consent, and re-selection semantics
...
Represent user permission state and re-selection without treating local path changes as project truth changes.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0616-define-source-root-permissions-consent-and-re-selection-semantics.md`
