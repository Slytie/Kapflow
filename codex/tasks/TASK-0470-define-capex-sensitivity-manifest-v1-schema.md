...
id: TASK-0470
epic: EPIC-145
title: "Define capex.sensitivity_manifest.v1 schema"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-002` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
schema + examples + negative tests
...
Implementation artifact(s) implied by W6-SLICE-002; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-002; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-002`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P0`
- Source area: `fixture/ai/security`
- Original depends_on: `source occurrence locators`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: source occurrence locators
