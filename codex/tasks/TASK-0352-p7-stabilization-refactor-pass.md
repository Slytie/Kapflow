...
id: TASK-0352
epic: EPIC-149
title: "P7 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P7-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Core CAPEX workflows implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P7-B`
- Source phase: `P7`
- Source priority: `P1`
- Source area: `refactoring`
- Original depends_on: `P7 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P7 implementation slices
- Recommended source branch: `feature/capex-p7-stabilize`
