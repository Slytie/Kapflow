...
id: TASK-0612
epic: EPIC-150
title: Define local deletion and missing-source evidence semantics
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0610, EPIC-145]
risk: critical
context_packs: [codex/context/EPIC-150.md]
patterns: [local_deletion_is_not_evidence_deletion]
---

# TASK-0612 — Define local deletion and missing-source evidence semantics
...
Mapped CAPEX / research source rows: `DFS-D06; DFS-RISK-004; DFS-TEST-003`.

## Objective

Ensure missing local file creates stale/missing-source review state and never deletes governed evidence.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0612-define-local-deletion-and-missing-source-evidence-semantics.md`
