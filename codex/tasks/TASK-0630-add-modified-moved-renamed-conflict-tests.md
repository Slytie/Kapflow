...
id: TASK-0630
epic: EPIC-150
title: Add modified/moved/renamed conflict tests
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0610]
risk: high
...
Mapped CAPEX / research source rows: `DFS-TEST-004; DFS-CORE-02`.

## Objective

Test digest changes, move candidates, duplicate candidates, and ambiguous renames become reviewable deltas.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0630-add-modified-moved-renamed-conflict-tests.md`
