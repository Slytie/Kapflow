...
id: TASK-0624
epic: EPIC-150
title: Specify projection freshness and stale-command guards for sync review
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [EPIC-144, TASK-0619]
risk: high
...
Mapped CAPEX / research source rows: `EPIC150-I-012; DFS-CORE-03`.

## Objective

Ensure Corpus Structure Review Workpage commands include projection token/basis and stale commands reject as no-op.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0624-specify-projection-freshness-and-stale-command-guards-for-sync-review.md`
