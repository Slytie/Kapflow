...
id: TASK-0611
epic: EPIC-150
title: Define watcher-as-hint semantics and deferred desktop-agent contract
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0607, TASK-0610]
risk: high
context_packs: [codex/context/EPIC-150.md]
patterns: [watcher_events_are_hints_only]
---
...
Mapped CAPEX / research source rows: `DFS-D04; DFS-RISK-003`.

## Objective

Define future watcher contract where events schedule scans and report health, but never mutate truth directly.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0611-define-watcher-as-hint-semantics-and-deferred-desktop-agent-contract.md`
