...
id: TASK-0613
epic: EPIC-150
title: Define local path redaction and privacy policy
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0608, EPIC-146]
risk: critical
context_packs: [codex/context/EPIC-150.md]
patterns: [RedactedPathRef, content_safe_logger]
---

# TASK-0613 — Define local path redaction and privacy policy
...
Mapped CAPEX / research source rows: `DST-010; DFS-CORE-04`.

## Objective

Prevent machine/user/folder path leakage into logs, AI prompts, screenshots, telemetry, exports, and CI artifacts.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0613-define-local-path-redaction-and-privacy-policy.md`
- `src/**/logging/redaction or content-safe telemetry helpers`
- `tests/**/leak sentinel tests`
