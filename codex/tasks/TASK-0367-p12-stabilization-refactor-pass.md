...
id: TASK-0367
epic: EPIC-149
title: "P12 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P12-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Post-MVP pressure-surface modules implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P12-B`
- Source phase: `P12`
- Source priority: `P1`
- Source area: `refactoring`
- Original depends_on: `P12 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P12 implementation slices
- Recommended source branch: `feature/capex-p12-stabilize`
