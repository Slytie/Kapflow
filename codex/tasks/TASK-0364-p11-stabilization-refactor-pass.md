...
id: TASK-0364
epic: EPIC-149
title: "P11 stabilization/refactor pass"
status: TODO
owners: ["platform"]
...
## Why
Imported from CAPEX v6 source task `QD-P11-B` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
Run behavior-preserving cleanup after Documentation and engineering operating model implementation; retire scaffolds or create debt records.
...
## Source row mapping
- Source task ID: `QD-P11-B`
- Source phase: `P11`
- Source priority: `P1`
- Source area: `refactoring`
- Original depends_on: `P11 implementation slices`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: P11 implementation slices
- Recommended source branch: `feature/capex-p11-stabilize`
