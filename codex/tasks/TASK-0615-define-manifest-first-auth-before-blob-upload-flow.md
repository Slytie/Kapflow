...
id: TASK-0615
epic: EPIC-150
title: Define manifest-first auth-before-blob-upload flow
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [EPIC-139, EPIC-140, TASK-0609]
risk: critical
...
Mapped CAPEX / research source rows: `DFS-DELTA-002`.

## Objective

Require project authorization before ingest manifest acceptance and blob upload/read.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0615-define-manifest-first-auth-before-blob-upload-flow.md`
