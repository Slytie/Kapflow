...
Mapped CAPEX / research source rows: `DST-001; DFS-D01`.

## Objective

Decide and document Stage 1 manual import, Stage 2 manual resync, and Stage 3 deferred desktop agent boundary.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0607-freeze-epic-150-stage-model-and-mvp-non-mvp-boundary.md`
