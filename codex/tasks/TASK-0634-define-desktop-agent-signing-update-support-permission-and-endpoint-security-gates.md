...
id: TASK-0634
epic: EPIC-150
title: Define desktop-agent signing, update, support, permission, and endpoint-security gates
status: TODO
...
Mapped CAPEX / research source rows: `DFS-CORE-01; DFS-CORE-04`.

## Objective

Define conditions before any persistent desktop agent can ship or pilot.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0634-define-desktop-agent-signing-update-support-permission-and-endpoint-security-gates.md`
