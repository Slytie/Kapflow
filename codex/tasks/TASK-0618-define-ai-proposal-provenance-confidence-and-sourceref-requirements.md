...
id: TASK-0618
epic: EPIC-150
title: Define AI proposal provenance, confidence, and SourceRef requirements
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0617, EPIC-142]
risk: high
...
Ensure AI proposal rows identify source occurrences, model version, prompt version, confidence, and unresolved evidence warnings.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0618-define-ai-proposal-provenance-confidence-and-sourceref-requirements.md`
