...
id: TASK-0639
epic: EPIC-150
title: Define performance and scale smoke tests for source-root snapshot/resync
status: TODO
owners: [capex-platform]
reviewers: [backend, capex-architecture]
depends_on: [TASK-0610, EPIC-148]
risk: medium
...
Mapped CAPEX / research source rows: `DFS-CORE-02`.

## Objective

Set bounds for scanning, diffing, and reviewing thousands of documents without full-corpus workpage load.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0639-define-performance-and-scale-smoke-tests-for-source-root-snapshot-resync.md`
