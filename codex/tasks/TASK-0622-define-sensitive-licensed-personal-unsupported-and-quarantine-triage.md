...
id: TASK-0622
epic: EPIC-150
title: Define sensitive, licensed, personal, unsupported, and quarantine triage
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0613, TASK-0617]
risk: critical
context_packs: [codex/context/EPIC-150.md]
patterns: [EPIC-150 desktop source-root observation pipeline]
---

# TASK-0622 — Define sensitive, licensed, personal, unsupported, and quarantine triage
...
Add triage states and policy handling for sensitive or non-ingestable desktop content.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0622-define-sensitive-licensed-personal-unsupported-and-quarantine-triage.md`
