...
id: TASK-0631
epic: EPIC-150
title: Add content-safe logging and telemetry policy hooks
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0613, TASK-0628]
risk: critical
...
Ensure desktop source-root telemetry emits redacted identifiers and no raw paths/content.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0631-add-content-safe-logging-and-telemetry-policy-hooks.md`
