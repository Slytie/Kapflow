...
id: TASK-0642
epic: EPIC-150
title: Define EPIC-150 to EPIC-141 handoff for SourceRef resolution
status: TODO
owners: [capex-platform]
reviewers: [backend, security, capex-architecture]
depends_on: [TASK-0608, TASK-0614]
risk: high
...
Mapped CAPEX / research source rows: `DFS-CORE-02; EPIC-141`.

## Objective

Ensure desktop source-root occurrences become meaningful, resolved SourceRefs before evidence binding or downstream use.
...
- `docs/planning/epics/EPIC-150.md`
- `codex/context/EPIC-150.md`
- `codex/tasks/TASK-0642-define-epic-150-to-epic-141-handoff-for-sourceref-resolution.md`
