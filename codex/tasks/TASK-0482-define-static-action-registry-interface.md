...
id: TASK-0482
epic: EPIC-145
title: "Define static action registry interface"
status: TODO
...
## Why
Imported from CAPEX v6 source task `ARCH-W6-SLICE-014` so future work can be executed from repo-native backlog memory without loading the full master package.

## Scope
registry + import boundary tests
...
Implementation artifact(s) implied by W6-SLICE-014; source wave W6; CED-linked design note; tests; docs update
...
## Acceptance criteria
- Source output satisfied: Implementation artifact(s) implied by W6-SLICE-014; source wave W6; CED-linked design note; tests; docs update
...
## Source row mapping
- Source task ID: `ARCH-W6-SLICE-014`
- Source phase: `P10 Fixture and AI guardrails`
- Source priority: `P0`
- Source area: `fixture/ai/security`
- Original depends_on: `tool command guard`
- Converted repo dependencies: none
- Source dependency notes still to satisfy: tool command guard
