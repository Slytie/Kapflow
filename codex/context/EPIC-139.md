# EPIC-139 Context Pack - CAPEX domain-boundary cleanup

Purpose:
- Rehydrate the CAPEX v6 task tranche for `EPIC-139` without opening the full master package.
- Keep future work inside the existing one-truth runtime, approval, artifact, pointer, and event model.

## Imported source rows
MP-PR012, MP-PR013, MP-PR014, MP-PR015, MP-PR016, MP-PR017, MP-PR018, MP-PR019, ... (17 tasks total)

## Historical/reconciled aliases
- `V5-TASK-005` is a reconciled v5 historical alias for `TASK-0257`, `TASK-0561`.
