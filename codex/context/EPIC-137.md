# EPIC-137 Context Pack - CAPEX activation blockers and platform readiness

Purpose:
- Rehydrate the CAPEX v6 task tranche for `EPIC-137` without opening the full master package.
- Keep future work inside the existing one-truth runtime, approval, artifact, pointer, and event model.

## Imported source rows
MP-PR001, MP-PR002, MP-PR003, MP-PR004, MP-PR005, MP-PR006, MP-PR007, NU-CB-P0-002, ... (9 tasks total)

## Historical/reconciled aliases
- `V5-TASK-006` is a reconciled v5 historical alias for `TASK-0235`, `TASK-0562`.
