...
- This does not close parser adapters, extraction/OCR runtime, durable ingest job tables, queue workers, search service runtime, vector store activation, retrieval runtime, source occurrence relations, source locator unions, upload behavior, or reviewed evidence sufficiency.
