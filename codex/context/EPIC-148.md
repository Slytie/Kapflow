# EPIC-148 Context Pack - CAPEX off-repo full-corpus, capacity, backup, and restore readiness

Purpose:
- Rehydrate the CAPEX v6 task tranche for `EPIC-148` without opening the full master package.
- Keep future work inside the existing one-truth runtime, approval, artifact, pointer, and event model.

## Imported source rows
INGEST-010, TEST-003, SAFE-D-001, TP-TASK-007
