# EPIC-138 Context Pack - CAPEX production, lab, release, and deployment hardening

Purpose:
- Rehydrate the CAPEX v6 task tranche for `EPIC-138` without opening the full master package.
- Keep future work inside the existing one-truth runtime, approval, artifact, pointer, and event model.

## Imported source rows
MP-PR008, MP-PR009, MP-PR010, MP-PR011, MP-PR021, MP-PR022, MP-PR023, DEPLOY-001, ... (10 tasks total)
