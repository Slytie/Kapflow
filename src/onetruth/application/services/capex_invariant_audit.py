...
CAPEX_INVARIANT_REGISTRY: tuple[CapexInvariant, ...] = (
    ...
    CapexInvariant(
        ...
        description="The durable project anchor, direct memberships, first project child APIs, selector/dashboard slice, project-scope helper, and official pointer-family substrate exist, but authorization projections, pointer-promotion policy checks, source governance dependencies, richer CAPEX workpages, and activation remain blocked.",
    ),
    CapexInvariant(
