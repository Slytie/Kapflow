# Availability Request - Time off request to approved availability truth

This folder contains the target authored workflow surface for `availability_request.v1`.
