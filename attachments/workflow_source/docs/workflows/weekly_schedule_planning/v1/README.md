# Weekly Schedule Planning - Amazon route horizon to published base schedule

This folder contains the target authored workflow surface for `weekly_schedule_planning.v1`.
